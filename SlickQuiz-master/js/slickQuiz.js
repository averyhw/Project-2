...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  '<p class="quiz-space">Check My Answer!</p>',
                nextQuestionText: '<p class="quiz-space">Next &raquo;</p>',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: '<p class="quiz-space">Question %current of %total</p>',
                preventUnansweredText: '<p class="quiz-space">You must select at least one answer.</p>',
                questionTemplateText:  '%count. %text',
                scoreTemplateText: '<p class="quiz-space">%score / %total</p>',
